...
void CarDebugLogger::debug(char* s0, char* s1, char* s2, char* s3, char* s4, char* s5, char* s6, char* s7, char* s8, char* s9,
...
void CarDebugLoggable::setDebugEnabled(bool enabled) {
  _debugEnabled = enabled;
}

void CarDebugLoggable::setDebugLogger(CarDebugLogger* logger) {
  _logger = logger;
}

bool CarDebugLoggable::isDebugEnabled() {
  return (_logger != NULL) && _debugEnabled;
}

CarDebugLogger* CarDebugLoggable::getLogger() {
  return _logger;
}
